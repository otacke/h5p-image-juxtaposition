...
H5P.ImageJuxtaposition = (function ($) {
  ...
  C.prototype.attach = function ($container) {
    ...
    if (this.options.image1 && this.options.image1.path) {
      $image1 = ('<img class="left" src="' + H5P.getPath(this.options.image1.path, this.id) + '" data-label="' + this.options.label1 + '" alt="' + this.options.label1 + '">');
    }
    if (this.options.image2 && this.options.image2.path) {
      $image2 = ('<img class="right" src="' + H5P.getPath(this.options.image2.path, this.id) + '" data-label="' + this.options.label2 + '" alt="' + this.options.label2 + '">');
    }
    $container.append('<div class="juxtapose" data-startingposition="' + this.options.behavior.sliderStart + '%" data-mode="' + this.options.behavior.sliderOrientation + '">' + $image1 + $image2 + '</div>');
   ...
   */
   makeSlider = function (juxtapose, element, idx) {
  ...
  scanPage = function(juxtapose) {
    var elements = document.querySelectorAll('.juxtapose');
    for (var i = 0; i < elements.length; i++) {
      makeSlider(juxtapose, elements[i], i);
    }
  };
